...
- 기준일: 2026-09-25
- 현재 상태: **Day 0 실습 완료(0-1~0-5). Day 1 주요 학습·1-3 검증 완료, 마무리 남음. Day 2 실습 2-1~2-7 및 자원 정리 완료.**
...
1. Day 2는 실습·정리 완료 상태다. 별도 자기점검 및 Day 3 시작은 사용자 요청에 따라 진행한다. Day 3을 요청하면 해당 README·SESSION·가이드부터 읽는다.
