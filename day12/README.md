...
- 가이드: [해당 Day 원문](../docs/guide/src/13-day12.md)
...
## 실습 파일
- [00-zones.yaml](00-zones.yaml)
- [10-workloads.yaml](10-workloads.yaml)
- [20-netpol.yaml](20-netpol.yaml)
- [21-egress.yaml](21-egress.yaml)
